...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!MenuUIController.instance.pawzScreen.activeInHierarchy && !GameController.instance.levelEnding)
        {
    ...
    public void FireShot()
    {
        if (activeGun.currentAmmo > 0)
        {
            ...
            PlayerUIController.instance.ammoText.text = "AMMO: " + activeGun.currentAmmo;
